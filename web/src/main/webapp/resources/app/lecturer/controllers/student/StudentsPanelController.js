        ...
        function ($rootScope, $scope, $modal, $http, studentsService, ngTableParams, $translate, $timeout, toaster, $filter) {
            ...
            $scope.openAddStudentModal = function() {
                var addStudent = $modal.open({
                    ...
                    templateUrl : '/resources/app/lecturer/views/modals/students/student-add-modal.html',
                    size: 'md'
                });
                    ...
                    function(data) {
                        ...
                        var studentDTOModal = $modal
                            .open({
                                ...
                                templateUrl : '/resources/app/lecturer/views/modals/students/student-edit-modal.html',
                                size: 'md'
                            });
