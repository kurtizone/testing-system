    ...
    [
        ...
        function ($rootScope, $scope, $translate, $modalInstance,
            ...
            $scope.checkIfUsernameIsAvailable = function () {
                var username = $scope.addLecturerFormData.username;
                    console.log($scope.addLecturerFormData.username);
                lecturersService.isUsernameAvailable(username).then(
                    function (data) {
                        $scope.isUsernameAvailable = data;
                        if ($scope.addLecturerFormData.username === undefined) {
                            $scope.addLecturerForm.username.$valid = !data;
                            $scope.addLecturerForm.username.$invalid = data;
                        } else {
                            $scope.addLecturerForm.username.$valid = data;
                            $scope.addLecturerForm.username.$invalid = !data;
                        }
